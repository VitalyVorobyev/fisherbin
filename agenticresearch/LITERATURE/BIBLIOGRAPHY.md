...
| `Graf-Luschgy-2000` | Foundations of Quantization for Probability Distributions | `LITERATURE/topics/04-vector-quantization.md` — Graf & Luschgy (2000, 2002) | `OPEN-DS-MARGINS-AT-OPTIMA` |
...
| `Kieffer-1983` | Uniqueness of locally optimal quantizer for log-concave density and convex error weighting function | `LITERATURE/topics/04-vector-quantization.md` — Scalar quantizer uniqueness (log-concave laws) | `OPEN-DS-MARGINS-AT-OPTIMA` |
| `Levrard-2015` | Nonasymptotic bounds for vector quantization in Hilbert spaces | `LITERATURE/topics/04-vector-quantization.md` — Margin conditions in quantization | `OPEN-DS-MARGINS-AT-OPTIMA` |
...
| `Pollard-1981` | Strong Consistency of K-Means Clustering | `LITERATURE/topics/04-vector-quantization.md` — Pollard (1981, 1982) and the k-means consistency cluster | `OPEN-DS-MARGINS-AT-OPTIMA` |
...
| `Silvey-1978` | Optimal design measures with singular information matrices | `LITERATURE/topics/01-optimal-design.md` — Design-side margins: weight bounds, singular \(D_s\) designs, extreme-point selection (29 Aug 2026) | `OPEN-DS-MARGINS-AT-OPTIMA` |
