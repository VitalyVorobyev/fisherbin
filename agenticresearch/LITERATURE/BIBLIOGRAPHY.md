...
| `Rakhlin-Caponnetto-2006` | Stability of K-Means Clustering | `LITERATURE/topics/04-vector-quantization.md` — Rakhlin & Caponnetto (2006): almost-minimizer rigidity | `AUDIT-DS-STABLE-MARGINS-COMPILE`, `DS-PROFILED-COMPILE-CERTIFICATE`, `DS-STABLE-MARGINS-PRICE` |
...
| `Telgarsky-Vattani-2010` | Hartigan's Method: k-means Clustering without Voronoi | `LITERATURE/topics/04-vector-quantization.md` — Hartigan one-point terminal geometry (30 Aug 2026) | `AUDIT-DS-STABLE-MARGINS-COMPILE`, `DS-STABLE-STATE-SELECTION` |
