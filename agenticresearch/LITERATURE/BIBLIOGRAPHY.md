...
| `Rakhlin-Caponnetto-2006` | Stability of K-Means Clustering | `LITERATURE/topics/04-vector-quantization.md` — Rakhlin & Caponnetto (2006): almost-minimizer rigidity | `AUDIT-DS-STABLE-MARGINS-COMPILE`, `DS-PROFILED-COMPILE-CERTIFICATE`, `DS-STABLE-BASINS-CENTERED-OBSTRUCTION`, `DS-STABLE-MARGINS-PRICE` |
...
| `Serinko-Babu-1992` | Weak limit theorems for univariate k-mean clustering under a nonregular condition | `LITERATURE/topics/04-vector-quantization.md` — Principal points and self-consistency (31 Aug 2026) | `DS-STABLE-BASINS-FIXED-POINT-GATE` |
...
| `Tarpey-Flury-1996` | Self-consistency: a fundamental concept in statistics | `LITERATURE/topics/04-vector-quantization.md` — Principal points and self-consistency (31 Aug 2026) | `DS-STABLE-BASINS-CENTERED-OBSTRUCTION`, `DS-STABLE-BASINS-FIXED-POINT-GATE`, `DS-STABLE-BASINS-LCM-CLASSIFICATION` |
| `Tarpey-Li-Flury-1995` | Principal points and self-consistent points of elliptical distributions | `LITERATURE/topics/04-vector-quantization.md` — Principal points and self-consistency (31 Aug 2026) | `DS-STABLE-BASINS-CENTERED-OBSTRUCTION`, `DS-STABLE-BASINS-LCM-CLASSIFICATION` |
| `Telgarsky-Vattani-2010` | Hartigan's Method: k-means Clustering without Voronoi | `LITERATURE/topics/04-vector-quantization.md` — Hartigan one-point terminal geometry (30 Aug 2026) | `AUDIT-DS-STABLE-MARGINS-COMPILE`, `DS-STABLE-BASINS-CENTERED-OBSTRUCTION`, `DS-STABLE-STATE-SELECTION` |
