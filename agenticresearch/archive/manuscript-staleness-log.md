# Manuscript staleness log (archived 5 September 2026)

Dated record of manuscript-versus-registry staleness, moved out of `manuscripts/README.md`. Current state is summarized there; this log is history only.
